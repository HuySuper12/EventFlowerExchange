...
function CancelOrder_Page() {
  ...
  return (
    <>
      ...
      <div className="border-t pt-16 ml-[750px] mr-[300px] mb-[30px]">
        <div className="text-2xl">
          <div className="inline-flex items-center gap-2 mb-2 mt-10">
            <p className="prata-regular text-3xl">Cancel Order</p>
          </div>
        </div>
      </div>
      ...
      <Form className="ml-[300px] mt-[50px] w-[1100px]" onFinish={handleSubmit}>
        <Form.Item
...
export default CancelOrder_Page;
